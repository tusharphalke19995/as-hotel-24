                                ...
                                <div className="contact-widget footer-widget">
                                    ...
                                    <div className="widget-content">
                                        ...
                                        <ul className="info-list clearfix">
                                            ...
                                            <li><i className="icon-3"></i><Link href="mailto:dhananjayphalke7058@gmail.com">dhananjayphalke7058@gmail.com</Link></li>
                                            <li><i className="icon-2"></i><Link href="tel:9130375375">9130375375</Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
